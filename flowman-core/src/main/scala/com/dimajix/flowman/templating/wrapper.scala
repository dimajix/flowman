...
object TimestampWrapper {
    ...
    def add(value:String, duration:String) : UtcTimestamp = UtcTimestamp.parse(value).plus(Duration.parse(duration))
    def add(value:String, duration:Duration) : UtcTimestamp = UtcTimestamp.parse(value).plus(duration)
    def add(value:UtcTimestamp, duration:String) : UtcTimestamp = value.plus(Duration.parse(duration))
    def add(value:UtcTimestamp, duration:Duration) : UtcTimestamp = value.plus(duration)
    def subtract(value:String, duration:String) : UtcTimestamp = UtcTimestamp.parse(value).minus(Duration.parse(duration))
    def subtract(value:String, duration:Duration) : UtcTimestamp = UtcTimestamp.parse(value).minus(duration)
    def subtract(value:UtcTimestamp, duration:String) : UtcTimestamp = value.minus(Duration.parse(duration))
    def subtract(value:UtcTimestamp, duration:Duration) : UtcTimestamp = value.minus(duration)
}
...
object LocalDateTimeWrapper {
    ...
    def add(value:String, duration:String) : LocalDateTime = LocalDateTime.parse(value).plus(Duration.parse(duration))
    def add(value:String, duration:Duration) : LocalDateTime = LocalDateTime.parse(value).plus(duration)
    def add(value:LocalDateTime, duration:String) : LocalDateTime = value.plus(Duration.parse(duration))
    def add(value:LocalDateTime, duration:Duration) : LocalDateTime = value.plus(duration)
    def subtract(value:String, duration:String) : LocalDateTime = LocalDateTime.parse(value).minus(Duration.parse(duration))
    def subtract(value:String, duration:Duration) : LocalDateTime = LocalDateTime.parse(value).minus(duration)
    def subtract(value:LocalDateTime, duration:String) : LocalDateTime = value.minus(Duration.parse(duration))
    def subtract(value:LocalDateTime, duration:Duration) : LocalDateTime = value.minus(duration)
