...
package of Flowman 0.25.0 and for Spark 3.2 and Hadoop 3.3 would be
```
flowman-dist-0.25.0-oss-spark32-hadoop33-bin.tar.gz
```
and the full URL then would be
```
https://github.com/dimajix/flowman/releases/download/0.25.0/flowman-dist-0.25.0-oss-spark3.2-hadoop3.3-bin.tar.gz
```
