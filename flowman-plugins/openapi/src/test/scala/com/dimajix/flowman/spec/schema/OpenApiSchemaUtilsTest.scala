...
class OpenApiSchemaUtilsTest extends AnyFlatSpec with Matchers  {
    "A OpenAPI schema" should "be deserializable" in {
        val spec =
            """
              |openapi: "3.0"
              |info:
    ...
    it should "support timestamps and dates" in {
        ...
        val fields = OpenApiSchemaUtils.fromOpenApi(spec, Some("SomeObject"), false)
        fields should be (Seq(
    ...
    it should "support simple arrays" in {
        ...
        val fields = OpenApiSchemaUtils.fromOpenApi(spec, Some("Address"), false)
        fields should be (Seq(
    ...
    it should "support integers, floats, doubles and decimals" in {
        ...
        val fields = OpenApiSchemaUtils.fromOpenApi(spec, Some("Types"), false)
