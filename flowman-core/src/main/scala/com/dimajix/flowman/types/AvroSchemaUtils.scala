    ...
    private def toAvroDefault(field:Field) : AnyRef = {
        field.default.map  { default =>
            field.ftype match {
                ...
                case IntegerType => new Integer(default.toInt)
                case ByteType => new Integer(default.toInt)
                case ShortType => new Integer(default.toInt)
                case LongType => new java.lang.Long(default.toLong)
                case FloatType => new java.lang.Double(default.toDouble)
                case DoubleType => new java.lang.Double(default.toDouble)
