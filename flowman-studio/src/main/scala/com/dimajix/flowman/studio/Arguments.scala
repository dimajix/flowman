...
class Arguments(args:Array[String]) {
    ...
    @Option(name = "--studio-id", usage = "set the studio ID used for registration", metaVar = "<studio_id>")
    var studioId: String = ""
    @Option(name = "--hub-secret", usage = "set the secret to use for communication with the Flowman Hub server", metaVar = "<hub_secret>")
    var hubSecret: String = ""
    @Option(name = "--hub-url", usage = "set the URL to register to", metaVar = "<hub_url>")
    var hubUrl: String = ""
    ...
    var sparkName: String = "Flowman Studio"
