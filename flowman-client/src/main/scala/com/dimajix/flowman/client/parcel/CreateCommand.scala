...
class CreateCommand extends Command {
    ...
    @Argument(usage = "specifies the parcel to create", metaVar = "<workspace>/<parcel>", required = true)
    var fqParcel: String = ""
    ...
    override def execute(httpClient:CloseableHttpClient, baseUri:URI) : Boolean = {
        ...
        val request = new HttpPost(baseUri.resolve(s"workspace/$workspace/parcel/$parcel"))
