...
class Server(
    ...
    def run(): Unit = {
        val route = (
                ...
                ~
                pathEndOrSingleSlash {
                    getFromResource("META-INF/resources/webjars/flowman-hub-ui/index.html")
                }
                ~
                getFromResourceDirectory("META-INF/resources/webjars/flowman-hub-ui")
            )
