...
import com.dimajix.dataflow.tools.exec.mapping.MappingCommand
import com.dimajix.dataflow.tools.exec.model.ModelCommand
...
class Arguments(args:Array[String]) {
    ...
    var configFile: String = "project.yaml"
