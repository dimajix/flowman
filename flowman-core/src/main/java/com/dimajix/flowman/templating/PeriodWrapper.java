...
public class PeriodWrapper {
    public Period ofYears(String years) { return Period.ofYears(Integer.parseInt(years)); }
    public Period ofYears(int years) { return Period.ofYears(years); }
    public Period ofMonths(String months) { return Period.ofMonths(Integer.parseInt(months)); }
    public Period ofMonths(int months) { return Period.ofMonths(months); }
    public Period ofWeeks(String weeks) { return Period.ofWeeks(Integer.parseInt(weeks)); }
    public Period ofWeeks(int weeks) { return Period.ofWeeks(weeks); }
    public Period ofDays(String days) { return Period.ofDays(Integer.parseInt(days)); }
