...
class H2JdbcViewRelationTest extends AnyFlatSpec with Matchers with LocalSparkSession {
    ...
    "The (H2) JdbcViewRelation" should "support the full lifecycle" in {
        val spec =
            s"""
               |connections:
               |  c0:
        ...
        viewRelation.conforms(execution, MigrationPolicy.RELAXED) should be (Unknown)
        viewRelation.conforms(execution, MigrationPolicy.STRICT) should be (Unknown)
    ...
    it should "support migrations" in {
        ...
        view1.conforms(execution, MigrationPolicy.RELAXED) should be (Unknown)
        view1.conforms(execution, MigrationPolicy.STRICT) should be (Unknown)
        ...
        view2.conforms(execution, MigrationPolicy.RELAXED) should be (Unknown)
        view2.conforms(execution, MigrationPolicy.STRICT) should be (Unknown)
    ...
    it should "support migrating from a table to a view and vice versa" in {
        ...
        view.conforms(execution, MigrationPolicy.RELAXED) should be (Unknown)
        view.conforms(execution, MigrationPolicy.STRICT) should be (Unknown)
