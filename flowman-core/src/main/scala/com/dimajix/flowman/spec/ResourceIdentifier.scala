 ...
 * @param partition
 */
case class SimpleResourceIdentifier(override val category:String, override val name:String, override val partition:Map[String,String] = Map())
 ...
 * @param partition
 */
case class GlobbingResourceIdentifier(override val category:String, override val name:String, override val partition:Map[String,String] = Map())
extends ResourceIdentifier
{
 ...
 * @param partition
 */
case class RegexResourceIdentifier(override val category:String, override val name:String, override val partition:Map[String,String] = Map())
extends ResourceIdentifier
{
